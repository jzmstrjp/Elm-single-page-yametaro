...
var author$project$Page$Top$init = {count: 0, title: 'トップページ'};
...
var author$project$Main$viewNotFound = _List_fromArray(
	[
		A2(
		elm$html$Html$div,
		_List_Nil,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text(
						'カウント: ' + elm$core$String$fromInt(model.count))
					])),
				A2(
				elm$html$Html$button,
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Page$Top$Decrement)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('-')
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$Page$Top$Increment)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('+')
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Page$Users$viewGif(model)
			]));
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$class('gHeader')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$text(
										author$project$Main$getTitle(model.page))
									])),
								A2(
								elm$html$Html$div,
								_List_fromArray(
		...
		title: author$project$Main$getTitle(model.page)
	};
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Page.User.Msg":{"args":[],"type":"Api.Msg"},"Page.Users.Msg":{"args":[],"type":"Api.Msg"},"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"},"Api.User":{"args":[],"type":"{ id : Api.UserId, name : String.String }"},"Api.UserId":{"args":[],"type":"String.String"}},"unions":{"Main.Msg":{"args":[],"tags":{"LinkClicked":["Browser.UrlRequest"],"UrlChanged":["Url.Url"],"TopMsg":["Page.Top.Msg"],"UsersMsg":["Page.Users.Msg"],"UserMsg":["Page.User.Msg"],"RegistMsg":["Page.Regist.Msg"]}},"Api.Msg":{"args":[],"tags":{"GotUsers":["Result.Result Http.Error (List.List Api.User)"],"GotUser":["Result.Result Http.Error Api.User"]}},"Page.Regist.Msg":{"args":[],"tags":{"SubmitPost":[],"UpdateId":["String.String"],"UpdateName":["String.String"]}},"Page.Top.Msg":{"args":[],"tags":{"Increment":[],"Decrement":[]}},"Browser.UrlRequest":{"args":[],"tags":{"Internal":["Url.Url"],"External":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"List.List":{"args":["a"],"tags":{}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}}}}})}});}(this));